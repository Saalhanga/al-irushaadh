...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'hero.subtitle': 'Join your community in building a space that serves everyone. Share 1 square foot and leave your mark.',
  ...
  dv: {
    ...
    'project.building.title': 'ޔޫ.އައި.އެސް އޮފީސް ޢިމާރާތް',
    'project.building.desc': 'ހުށަހެޅިފައިވާ ޔޫ.އައި.އެސް އޮފީސް ޢިމާރާތަކީ މުސްލިމް މުޖުތަމަޢުގެ ތަފާތު ބޭނުންތައް ފުއްދައިދޭ ޒަމާނީ ތަނެކެވެ.',
    'project.purpose.title': 'އޮފީހުގެ ބޭނުން',
    'project.purpose.item1': 'ޔުނައިޓެޑް އިސްލާމިކް ސޮސައިޓީގެ އިދާރީ މަރުކަޒު',
  ...
  ar: {
    ...
    'project.purpose.item1': 'المقر الإداري للجمعية الإسلامية المتحدة',
