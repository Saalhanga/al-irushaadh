...
import { useDonationProgress, useBankAccounts } from '@/hooks/use-site-data';
...
const Sponsor = () => {
  ...
  const steps = [t('sponsor.step1'), t('sponsor.step2'), t('sponsor.step3'), t('sponsor.step4')];
    ...
    <div className="min-h-screen py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed">{t('sponsor.subtitle')}</p>
        </div>
            ...
            <CardContent className="space-y-4">
              <div className="bg-secondary/50 rounded-lg p-6 space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-muted-foreground text-sm">{account.bank_name}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">{t('sponsor.bank.account')}</span>
                  <div className="flex items-center gap-2">
                    <span className="font-mono font-semibold text-foreground">{account.account_number}</span>
                    <button onClick={copyAccount} className="p-1.5 rounded hover:bg-secondary transition-colors" aria-label="Copy account number">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-foreground">{account.account_holder}</span>
                </div>
              </div>
